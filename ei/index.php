        ...
        <div id="ekishara">
            ...
            <div id="uptxt">
                <div>
                    ...
                    <span style="font-size: 23px; color: #b9b9b9;"><b>Let's biuld a community for artists</b></span>
                </div>
                <div id="fifteen">
                    <span id="days"></span>
                    <span id="hours"></span>
        ...
        <div class="container-fluid" style="background-color: #ffffff; border-top-left-radius: 20px; border-top-right-radius: 20px;">
            <div class="container">
                ...
                <div id="toprow" align="center">
                    ...
                    <button class="aone btn btn-outline-primary" data-toggle="collapse" href="#collapseAbout" role="button" aria-expanded="false" aria-controls="collapseExample" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <button class="aone btn btn-outline-warning" data-toggle="collapse" href="#collapseMission" role="button" aria-expanded="false" aria-controls="collapseExample" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <button class="aone btn btn-outline-danger" onclick="window.location.href='#contact'" data-aos="fade-up" data-aos-delay="300">
                        <img src="../img/nav/contact.png" height="45px" width="auto">
                        <h5><b>Contact</b></h5>
                    </button>

                    <button class="aone btn btn-outline-success" onclick="window.location.href='why.php'" data-aos="fade-up" data-aos-delay="400">
                ...
                <div id="event">
                    ...
                    <div align="center">
                        <button id="d1btn" type="button" class="btn btn-outline-primary" data-aos="flip-left" data-aos-delay="175" data-toggle="modal" data-target="#dayOne"><i class="material-icons">card_giftcard</i> &nbsp; <b> Day 1</b>
                            <h4>Art Exhibition</h4>
                        </button>
                        <button id="d2btn" type="button" class="btn btn-outline-primary" data-aos="flip-right" data-aos-delay="175" data-toggle="modal" data-target="#dayTwo"><i class="material-icons">card_giftcard</i> &nbsp; <b> Day 2</b>
                            <h4>Poerty Slam</h4>
                        </button>
                    </div>
